...
class ImputeUBP(BaseNNImputer):
    def __init__(
        ...
        *,
        ...
        """Initialize the ImputeUBP class.

        This class is used to impute missing values in genotype data using Unsupervised Backpropagation (UBP). The model is trained on the genotype data and used to impute the missing values. The class inherits from the BaseNNImputer class.
