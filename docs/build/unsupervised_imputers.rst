...
This schematic VAE animation shows the distinction between observed calls
hidden for validation and calls missing from the original input. Its genotype
calls and displayed score are illustrative, not measured model results.

.. image:: ../../img/vae_imputation.gif
   :alt: Animated VAE imputation overview, from original gaps and held-out observed calls through prediction and validation.
   :align: center
