...
This schematic VAE animation distinguishes observed calls hidden for validation
from calls missing in the original input. Its genotype predictions are
illustrative, not measured model results.
