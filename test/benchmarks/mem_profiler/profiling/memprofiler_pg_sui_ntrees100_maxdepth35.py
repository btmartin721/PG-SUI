...
def main():
    ...
    prefix = "profiling_test_ntrees100_maxdepth35"
...
def get_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Convert VCF file to BGC format (with genotype uncertainties). Currently only handles three populations maximum (P1, P2, and Admixed).",
        add_help=False,
    )
